...
function makeDeleteUserNotification({ deleteDataUserNotification, internalServer, redisClient }) {
    return function deleteUserNotification(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield deleteDataUserNotification(bodyparam);
                    const entityLog = {
                        username: authMe.data.username,
                        moduleId: bodyparam.moduleId,
                        menuId: '',
                        screenId: 'General User Notificatio',
                        actionType: 'delete',
                        actionDetail: 'Delete Data User Notification',
...
exports.default = makeDeleteUserNotification;

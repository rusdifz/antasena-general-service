...
function makeUpdateUserNotification({ updateDataUserNotification, internalServer, redisClient }) {
    return function updateUserNotification(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield updateDataUserNotification(bodyparam);
                    const entityLog = {
                        username: authMe.data.username,
                        moduleId: bodyparam.moduleId || 'ANT',
                        menuId: '',
                        screenId: 'General User Notification',
                        actionType: 'update',
                        actionDetail: 'Update Data User Notification',
                        actionBeUrl: '/general/user/notification',
                        actionBeMethod: 'UPDATE'
                    };
...
exports.default = makeUpdateUserNotification;

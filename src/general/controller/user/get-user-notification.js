...
function makeGetUserNotification({ getDataUserNotification, internalServer, redisClient }) {
    return function getUserNotification(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataUserNotification(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'get',
                        actionDetail: 'Show List Data User Notification',

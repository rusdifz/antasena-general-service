...
function makeGetUserFilter({ getDataUserFilter, internalServer, redisClient }) {
    return function getUserModule(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataUserFilter(Object.assign(Object.assign({}, username), bodyparam));
                    const entityLog = {
                        ...
                        actionType: 'get',
                        actionDetail: 'Show List Data User Filter',
...
exports.default = makeGetUserFilter;

...
function makeUpdateUserFilter({ updateDataUserFilter, internalServer, redisClient }) {
    return function updateUserFilter(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield updateDataUserFilter(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'update',
                        actionDetail: 'Update Data User Filter',

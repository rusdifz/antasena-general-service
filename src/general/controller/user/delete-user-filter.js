...
function makeDeleteUserFilter({ deleteDataUserFilter, internalServer, redisClient }) {
    return function deleteUserFilter(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield deleteDataUserFilter(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'delete',
                        actionDetail: 'Delete Data User Filter',
...
exports.default = makeDeleteUserFilter;

...
function makeCreateUserNotification({ createDataUserNotification, internalServer, redisClient }) {
    return function createUserNotification(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield createDataUserNotification(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'create',
                        actionDetail: 'Create Data User Notification',

...
function makeUpdateNewsAdminFooterDetail({ updateDataNewsAdminFooterDetail, internalServer, redisClient }) {
    return function updateNewsAdminFooterDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield updateDataNewsAdminFooterDetail(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'update',
                        actionDetail: 'Update Data News Footer',
...
exports.default = makeUpdateNewsAdminFooterDetail;

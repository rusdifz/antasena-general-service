...
function makeDeleteNewsAdminFooterDetail({ deleteDataNewsAdminFooterDetail, internalServer, redisClient }) {
    return function deleteNewsAdminFooterDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield deleteDataNewsAdminFooterDetail(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'delete',
                        actionDetail: 'Delete Data News Footer',
                        actionBeUrl: '/general/news/admin/footer/detail',
...
exports.default = makeDeleteNewsAdminFooterDetail;

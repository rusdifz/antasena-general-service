...
function makeCreateNewsAdminFooterDetail({ createDataNewsAdminFooterDetail, internalServer, redisClient }) {
    return function createNewsAdminFooterDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield createDataNewsAdminFooterDetail(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'create',
                        actionDetail: 'Create Data News Footer',

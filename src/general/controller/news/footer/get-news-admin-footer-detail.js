...
function makeGetNewsAdminFooterDetail({ getDataNewsAdminFooterDetail, internalServer, redisClient }) {
    return function getNewsAdminFooterDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataNewsAdminFooterDetail(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'get',
                        actionDetail: 'Show List Data News Footer Detail',

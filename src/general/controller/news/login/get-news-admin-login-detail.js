...
function makeGetNewsAdminLoginDetail({ getDataNewsAdminLoginDetail, internalServer, redisClient }) {
    return function getNewsAdminLoginDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataNewsAdminLoginDetail(bodyparam);
                    const entityLog = {
                        ...
                        screenId: 'News Login',
                        actionType: 'get',
                        actionDetail: 'Show List Data News Login Detail',

...
function makeCreateNewsAdminLoginDetail({ createDataNewsAdminLoginDetail, internalServer, redisClient }) {
    return function createNewsAdminLoginDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield createDataNewsAdminLoginDetail(bodyparam);
                    const entityLog = {
                        ...
                        screenId: 'News Login',
                        actionType: 'create',
                        actionDetail: 'Create Data News Login',

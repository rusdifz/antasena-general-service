...
function makeGetNewsAdminLogin({ getDataNewsAdminLogin, internalServer, redisClient }) {
    return function getNewsAdminLogin(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataNewsAdminLogin(bodyparam);
                    const entityLog = {
                        ...
                        screenId: 'News Login',
                        actionType: 'get',
                        actionDetail: 'Show List Data News Login All',
                        actionBeUrl: '/general/news/admin/login',
                        actionBeMethod: 'GET'
                    };

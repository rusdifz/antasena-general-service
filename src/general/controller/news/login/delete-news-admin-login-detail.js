...
function makeDeleteNewsAdminLoginDetail({ deleteDataNewsAdminLoginDetail, internalServer, redisClient }) {
    return function deleteNewsAdminLoginDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield deleteDataNewsAdminLoginDetail(bodyparam);
                    const entityLog = {
                        ...
                        screenId: 'News Login',
                        actionType: 'delete',
                        actionDetail: 'Delete Data News Login',
...
exports.default = makeDeleteNewsAdminLoginDetail;

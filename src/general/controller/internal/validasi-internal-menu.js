...
function makeValidasiInternalMenu({ validasiDataInternalMenu }) {
    return function validasiInternalMenu(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const bodyparam = httpRequest.query;
                bodyparam.method = httpRequest.method;
                const posted = yield validasiDataInternalMenu(bodyparam);
                return {
                    headers: {
